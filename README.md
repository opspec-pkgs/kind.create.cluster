[![build](https://github.com/opspec-pkgs/kind.create.cluster/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/kind.create.cluster/actions/workflows/build.yml)
